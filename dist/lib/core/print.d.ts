...
export declare const isPrintStyleMessageArr: <T>(target: T | __SYMBLE_ARRAY__<[string, ...(string | __SYMBLE_MESSAGE__<string>)[]]>) => target is __SYMBLE_ARRAY__<[string, ...(string | __SYMBLE_MESSAGE__<string>)[]]>;
export declare const isPrintStyleMessage: <T>(target: __SYMBLE_MESSAGE__<string> | T) => target is __SYMBLE_MESSAGE__<string>;
